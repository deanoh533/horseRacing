...
- [ ] **U-003 테이블 가로 스크롤 힌트** — 우측 fade 또는 화살표로 스크롤 가능 표시
- [ ] **U-004 출마정보 행 펼치기 힌트** — chevron 아이콘으로 클릭 가능 행 명시
- [ ] **U-005 모바일 예상지 레이아웃** — 4열 그리드 → 모바일 최적화
...
- [ ] **E-001 출전 공백기** — 마지막 경주일~현재 경주일 계산, 30일+ 공백 시 표시
- [ ] **E-002 기수-말 조합 이력** — 이 기수가 이 말을 탄 횟수·성적 (race_entries 집계)
- [ ] **E-003 게이트별 성적** — `pthr_no` 기준 통산 성적 (안쪽/바깥쪽 경향 분석용)
...
- [ ] **F-002 연승식/복승식 조합 추천** — 예측 1-2위, 2-3위 조합 박스 표시
